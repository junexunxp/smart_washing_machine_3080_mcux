...
static void LOG_LPUART_RTOS_Callback(LPUART_Type *base, lpuart_handle_t *state, status_t status, void *param)
{
 ...
 */
int LOG_LPUART_RTOS_Init(lpuart_rtos_handle_t *handle, lpuart_handle_t *t_handle, const lpuart_rtos_config_t *cfg)
{
    ...
    LPUART_TransferCreateHandle(handle->base, handle->t_state, LOG_LPUART_RTOS_Callback, handle);
 ...
 */
int LOG_LPUART_RTOS_Deinit(lpuart_rtos_handle_t *handle)
{
 ...
 */
int LOG_LPUART_RTOS_Send(lpuart_rtos_handle_t *handle, const uint8_t *buffer, uint32_t length, uint32_t timeout)
{
    EventBits_t ev;
    ...
    if (pdFALSE == xSemaphoreTake(handle->txSemaphore, timeout))
    {
 ...
 */
int LOG_LPUART_RTOS_Receive(lpuart_rtos_handle_t *handle, uint8_t *buffer, uint32_t length, size_t *received, uint32_t timeout)
{
    EventBits_t ev;
    size_t n              = 0;
    int retval            = kStatus_Success;
