...
C_SRCS += \
../csdk/examples/dev_sign_example.c \
../csdk/examples/linkkit_example_solo.c \
../csdk/examples/mqtt_example_at.c 

OBJS += \
./csdk/examples/dev_sign_example.o \
./csdk/examples/linkkit_example_solo.o \
./csdk/examples/mqtt_example_at.o 

C_DEPS += \
./csdk/examples/dev_sign_example.d \
./csdk/examples/linkkit_example_solo.d \
./csdk/examples/mqtt_example_at.d 


# Each subdirectory must supply rules for building sources it contributes
csdk/examples/%.o: ../csdk/examples/%.c
	@echo 'Building file: $<'
