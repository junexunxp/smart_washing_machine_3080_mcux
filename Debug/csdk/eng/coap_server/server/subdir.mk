...
C_SRCS += \
../csdk/eng/coap_server/server/CoAPExport.c \
../csdk/eng/coap_server/server/CoAPMessage.c \
../csdk/eng/coap_server/server/CoAPNetwork.c \
../csdk/eng/coap_server/server/CoAPObserve.c \
../csdk/eng/coap_server/server/CoAPPlatform.c \
../csdk/eng/coap_server/server/CoAPResource.c \
../csdk/eng/coap_server/server/CoAPServer.c 

OBJS += \
./csdk/eng/coap_server/server/CoAPExport.o \
./csdk/eng/coap_server/server/CoAPMessage.o \
./csdk/eng/coap_server/server/CoAPNetwork.o \
./csdk/eng/coap_server/server/CoAPObserve.o \
./csdk/eng/coap_server/server/CoAPPlatform.o \
./csdk/eng/coap_server/server/CoAPResource.o \
./csdk/eng/coap_server/server/CoAPServer.o 

C_DEPS += \
./csdk/eng/coap_server/server/CoAPExport.d \
./csdk/eng/coap_server/server/CoAPMessage.d \
./csdk/eng/coap_server/server/CoAPNetwork.d \
./csdk/eng/coap_server/server/CoAPObserve.d \
./csdk/eng/coap_server/server/CoAPPlatform.d \
./csdk/eng/coap_server/server/CoAPResource.d \
./csdk/eng/coap_server/server/CoAPServer.d 


# Each subdirectory must supply rules for building sources it contributes
csdk/eng/coap_server/server/%.o: ../csdk/eng/coap_server/server/%.c
	@echo 'Building file: $<'
