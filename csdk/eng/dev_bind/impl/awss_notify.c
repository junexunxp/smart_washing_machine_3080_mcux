...
static const struct notify_map_t notify_map[] = {
    {AWSS_NOTIFY_DEV_BIND_TOKEN, METHOD_DEV_INFO_NOTIFY,       TOPIC_NOTIFY,                (void *)awss_dev_bind_notify_resp},
#ifdef WIFI_PROVISION_ENABLED
...
volatile static void *coap_session_ctx = NULL;
...
static int awss_process_get_devinfo()
{
    ...
    do {
        ...
        HAL_Free(buf);
        awss_release_coap_ctx((void *)coap_session_ctx);
