...
/* Task priorities. */
#define linkkit_runTASKPRIORITY (5 - 3)
void linkkit_init(void ){
	xTaskCreate(linkkit_task, "linkkit_run", 2048 + 10, NULL, linkkit_runTASKPRIORITY, NULL);

}


void linkkit_run(void )
{
    int res = 0;
    int cnt = 0;
    iotx_linkkit_dev_meta_info_t master_meta_info;
